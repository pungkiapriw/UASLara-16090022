...
@endif
          ...
          <div class="navbar-header">
            ...
            <div class="navbar-collapse collapse">
              <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="{{ url('admin/cat', []) }}"><i class="icon-lock icon-white"></i> Category</a></li>
	...
	<div class="row">
		...
		<h4 style="color:white;"><strong>Data Table Category</strong> <a style="position:relative;left:50%;" href="{{ url('admin/cat/create', []) }}">New Category <i class="fa fa-plus"></i></a> </h4>
