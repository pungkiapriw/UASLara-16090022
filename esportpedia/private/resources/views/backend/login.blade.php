...
<style>
  ...
  <body style="background:url('{{ asset('private/assets/backend/images/bg.jpg') }}') no-repeat center center; height:700px;">
        ...
        <div class="row">
   		<div class="col-lg-offset-4 col-lg-4" style="margin-top:100px">
   			<div class="block-unit" style="text-align:center; padding:8px 8px 8px 8px;">
   				<img src="{{ asset('private/assets/backend/images/ac.jpg') }}" alt="" class="img-circle">
   				<br>
   				<br>
    ...
    <script type="text/javascript" src="{{ asset('private/assets/backend/js/bootstrap.js') }}"></script>
