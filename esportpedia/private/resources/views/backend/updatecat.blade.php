        ...
        <div class="navbar-header">
          ...
          <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
              ...
              <li class="active"><a href="#"><i class="icon-user icon-white"></i> Update Category</a></li>
...
<section id="main-content">
    ...
    <div>
        ...
        @foreach ($item as $data)
            @php($nama_cat = $data->nama_kategori)
            @php($sub_cat = $data->sub_kategori)
            @php($id_cat = $data->id)
        @endforeach
        <h4><i class="fa fa-angle-right"></i>Nama Kategori</h4>
        <div class="row mt">
            <div class="col-sm-12">
                    {!! Form::open(array('url' =>  url('admin/cat', [$id_cat])   ,'method' => 'POST')) !!}
                    {{Form::text("Categori",
                                old("Categori") ? old("Categori") : (!empty($user) ? $user->judul : $nama_cat),
                                [
                                    "class" => "form-group",
    ...
    <div>
        ...
        <div class="row mt">
            <div class="col-sm-12">
                    {{Form::text("Tags",
                                old("Tags") ? old("Tags") : (!empty($user) ? $user->judul : $sub_cat),
                                [
                                    "class" => "form-group",
